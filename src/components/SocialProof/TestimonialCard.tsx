  ...
  return (
    ...
    >
      <div
        ...
        `}
      >
        <ImQuotesRight className="w-4 h-4 text-accent md:w-6 md:h-6" />
      </div>
      <p className="text-left text-[#21262C] opacity-70 py-6 leading-6 md:leading-7">
        {quote}
      </p>
      <div className="flex items-center">
        <BiUser className="w-8 h-8 text-[#21262C] border border-[#21262C] rounded-full mr-4 md:w-9 md:h-9" />
        <div>
